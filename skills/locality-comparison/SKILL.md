...
description: Compare Maltese towns and areas on price, rental demand, livability, and SDA availability to shortlist localities that fit a dual home-and-income mandate.
---

# Locality Comparison

Use this skill to narrow "somewhere in Malta" down to a defensible shortlist of areas.

## When to use
- After a market baseline exists and you need to choose where to focus.

## Method
1. **Assemble the candidate set.** Cover the main archetypes rather than just the famous names:
   - **Harbour / urban core** — Sliema, St Julian's, Gzira: deepest rental demand, highest prices, thinnest yields.
...
## Key decision flag
Mark which candidate areas contain **SDA developments**. Under the AIP regime a non-resident is generally limited to one property used as a residence that cannot be let, whereas SDA property can be let and held in multiples — so SDA availability often determines whether "live and rent" is even possible in an area.
